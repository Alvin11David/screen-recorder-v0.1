...
import { I as Mail, Q as EyeOff, R as Lock, Z as Eye, l as User, lt as CircleAlert, u as UserPlus, z as LoaderCircle } from "../_libs/lucide-react.mjs";
import { n as SocialLoginButtons, t as AuthLayout } from "./SocialLoginButtons-C_vaKHEI.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/register-BOG5ZtwT.js
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
						...
						className: "relative",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(User, { className: "absolute left-3.5 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground/40 pointer-events-none" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
							id: "name",
							type: "text",
							value: name,
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
					...
					children: [isLoading ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoaderCircle, { className: "h-4 w-4 animate-spin" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(UserPlus, { className: "h-4 w-4" }), isLoading ? "Creating account..." : "Create account"]
				}),
