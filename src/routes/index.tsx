  ...
  return (
    <main className="relative min-h-screen overflow-x-hidden">
      ...
      >
        ...
        <motion.div
          variants={fadeUp}
          className="flex flex-wrap items-center justify-between gap-3 mb-8 md:mb-12"
        >
          ...
          <div className="flex flex-wrap items-center justify-end gap-2">
            ...
            <button
              ...
              title={`Recording History (${modifierLabel}+H)`}
            ...
            <button
              ...
              title={`Keyboard Shortcuts (${modifierLabel}+K)`}
              className="flex h-8 w-8 items-center justify-center rounded-lg text-white/30 ring-1 ring-white/[0.06] transition-all hover:bg-white/[0.06] hover:text-white/70 hover:ring-white/[0.12]"
            >
            ...
            <button
              ...
              title={`Teleprompter (${modifierLabel}+T)`}
              className={cn(
            ...
            >
              ...
              {screenUnsupported && !androidStandalone && (
                <motion.p
                  ...
                  className="mt-3 rounded-xl bg-amber-500/[0.07] px-4 py-3 text-xs leading-relaxed text-amber-200/70 ring-1 ring-amber-500/20"
                >
                  Screen capture isn't supported in this browser. Use your phone's built-in screen
                  recorder and upload the video below.
                </motion.p>
              )}
            </motion.div>
          )}
